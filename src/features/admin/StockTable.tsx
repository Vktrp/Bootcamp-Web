  ...
  return (
    <div className="container-page" style={{ maxWidth: 1200 }}>
      <style>{`
        ...
        /* Thème clair : contraste amélioré */
      ...
      <div className="card admin-wrapper" style={{ overflowX: "auto" }}>
        <table
          ...
          style={{
            tableLayout: "fixed",
            width: "100%",
            minWidth: 1120, // force un scroll horizontal si écran trop étroit
        ...
        >
          <colgroup>
            <col style={{ width: 320 }} /> {/* Variant ID */}
            <col style={{ width: 150 }} /> {/* SKU */}
            <col style={{ width: 420 }} /> {/* Produit */}
            <col style={{ width: 90 }} /> {/* Pointure */}
            <col style={{ width: 90 }} /> {/* Stock */}
            <col style={{ width: 170 }} />{" "}
            {/* Actions (un peu plus large pour lisibilité) */}
          </colgroup>
