...
// imports déjà en place…

// ⚠️ Assure-toi que les chemins d’import respectent la casse exacte des fichiers.
// ex: "./components/Header", "./styles/global.css", etc.
    ...
    <div className="app-container">
      ...
      <main className="main-content">
        <Routes>
          ...
          {/* Seller: manageStock autorise seller OU admin */}
          <Route
            path="/seller"
            element={
          ...
          {/* Admin zone: accès admin uniquement */}
          <Route
            path="/admin"
            element={
          ...
          <Route
            ...
            element={
              <RoleGuard action="manageProducts">
                <CreateProduct />
              </RoleGuard>
            }
          />
