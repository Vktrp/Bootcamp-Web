...
import { toggleFavorite, selectIsFavorite } from "../favorites/slice";
...
export default function ProductPage() {
  ...
  const isFav = useSelector(selectIsFavorite(p?.id ?? ""));
  ...
  }, [colorOptions, sizesForColor, colorKey, size]);
  ...
  async function addToCart() {
    ...
    try {
      dispatch(
        addItem({
          sku: String((exactVariant as any).sku),
          ...
          image:
            ((exactVariant as any).image as string | undefined) ??
      ...
      <div className="product-layout">
        ...
        <div className="product-info">
          ...
          <div className="actions mt-4">
            ...
            <button
              className={`btn-outline fav-btn${isFav ? " active" : ""}`}
